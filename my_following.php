...
$uid = $_SESSION['myid'];
$picfoll = mysql_query("SELECT * FROM followers WHERE fuid = '$uid' AND authorized = 'yes' ORDER BY timestamp DESC");
                      ...
                      <tr>
                        ...
                        <div id="profile" align="center" style="width:155px !important;">
                            ...
                            <div id="info" style="min-height:260px;">
                                ...
                                <div class="profile_links"><a href="<?php echo $_SESSION['uname']; ?>/following/" style="color:#f7e410">Following (<span id="get_followings">&nbsp;</span>)</a></div>
                        ...
                        <div id="recent_pic" style="height:480px; width:400px !important;">
                            <h2 align="left">Following (<?php echo $count;?>)</h2><br />
                                ...
                                <div class="customScrollBox">
                                    <div class="container">
                                        <div class="content">
                                            ...
                                            if($count == 0){?>
                                            <div align="center">
                                            	<img src="images/characters/my_followings.png" alt="You are following '0' people" />
                                            </div>
                                            <?php }else{
												
                                                while($cont = mysql_fetch_array($picfoll)){
													$follow = mysql_query("
													SELECT * FROM users INNER JOIN location ON location.uid = '".$cont[1]."' 
													WHERE users.uid = '".$cont[1]."'");
													$follo = mysql_fetch_array($follow);?>
                                            <div id="list" style="width:300px; height:55px;">
                                            <a href="/<?php echo $follo['username'];?>/" style="text-decoration:none;">
                                            <table width="300" border="0" cellspacing="0" cellpadding="0">
                                              <tr>
                                                <td width="50" align="center" valign="middle">
												<?php $pictur = mysql_query("SELECT picture FROM profile_pic WHERE uid = '$cont[1]'");
