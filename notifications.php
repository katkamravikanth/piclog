...
$uid = $_SESSION['myid'];
$activity = mysql_query("SELECT * FROM activities WHERE fuid = '$uid' AND uid != '$uid' ORDER BY timestamp DESC");
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <div id="profile" align="center" style="width:155px !important;">
                            <div id="pic" align="center" onMouseOver="$('#updatepic').show();" onMouseOut="$('#updatepic').hide();">
                                ...
                                <div id="updatepic" onMouseOver="$(this).show();">
                                	<a href="profile_pic.php" style="text-decoration:none; color:#FFF;">
                            ...
                            <div id="info" style="min-height:260px;">
                                ...
                                <div class="profile_links"><a href="<?php echo $_SESSION['uname']; ?>/favorites/">Favorites 
                                	(<span id="get_favorites">&nbsp;</span>)</a></div>
                                <div class="profile_links"><a href="<?php echo $_SESSION['uname']; ?>/following/">Following 
                                	(<span id="get_followings">&nbsp;</span>)</a></div>
                                <div class="profile_links"><a href="<?php echo $_SESSION['uname']; ?>/followers/" style="color:#f7e410">Followers 
                                	(<span id="get_followers">&nbsp;</span>)</a></div>
                        ...
                        <div id="recent_pic" style="height:480px; width:400px !important;">
                            <h2 align="left">NOTIFICATIONS</h2><br />
                                    ...
                                    <div class="container">
                                        <div class="content">
                                            <div id="left" style="margin-top:10px; margin-bottom:10px;">
												<?php if($num == 0){
                                                    echo '<span class="searchheading">There are no notifications yet.</span>';
                                                }else{
													while($active = mysql_fetch_array($activity)){?>
                                                        <div class="notifictions" style="width:100% !important; height:60px;">
                                                            <!--<a href="piclogger.php?piclogger=<?php echo md5($active['uid']); ?>">-->
                                                            <table width="98%" border="0" cellspacing="0" cellpadding="0">
                                                              <tr>
                                                                <td width="50" align="left">
																<a href="<?php echo $active['link'];?>/">
                                                                <?php $picture = mysql_query("SELECT * FROM profile_pic WHERE uid = '".$active['uid']."'");
                                                                $pic = mysql_fetch_array($picture);
                                                                if($pic['picture'] == ''){
                                                                    echo '<img src="images/icons/profile1.png" width="40" height="40" alt="Profile picture" />';
                                                                }else{
                                                                    echo '<img src="'.$pic['picture'].'" width="40" height="40" alt="Profile picture" />';
                                                                }?></a></td>
                                                                <td align="left">
                                                                <div class="text1" style="font-size:13px;" align="left">
                                                                <span style="color:#333; text-transform:capitalize;"><a href="piclogger.php?piclogger=<?php echo md5($active['uid']);?>">
                                                                <?php $users = mysql_query("SELECT * FROM users WHERE uid = '".$active['uid']."'");
                                                                $user = mysql_fetch_array($users);
                                                                echo $user['full_name'];?></a></span>
                                                                <?php 
																$you = "<a href='/".$_SESSION['uname']."/'>".$_SESSION['fname']."&acute;s</a>";
																if(stristr($active['activity'],$you)){
																	echo stripslashes(str_replace($you, "your", $active['activity']));
																}else {
																	echo stripslashes($active['activity']);
																}?>
                                                                </div></td>
                                                              </tr>
                                                            </table><!--</a>-->
